// TODO §3.1 — `plank` : Le plateau à bille (side · coop).
// Vue de dessus, une bille, deux commandes : P0 tient l'inclinaison en X, P1 celle en Y. Six parcours, sous-pas de collision obligatoire.
//
// ─────────────────────────────────────────────────────────────────────────────
