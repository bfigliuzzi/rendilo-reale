// TODO §3.7 — `beast` : La bête sous le tapis (pass · asym).
// Grille 6×8 : la bête avance d'une case, le chasseur éclaire trois cases et lit un thermomètre à triple codage.
//
// ─────────────────────────────────────────────────────────────────────────────
