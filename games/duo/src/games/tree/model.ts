// TODO §3.3 — `tree` : La branche coupée (pass · duel).
// Hackenbush aux pommes : on coupe une brindille de sa couleur, ce qui n'est plus relié au sol tombe, les pommes tombées vont au panier.
//
// ─────────────────────────────────────────────────────────────────────────────
