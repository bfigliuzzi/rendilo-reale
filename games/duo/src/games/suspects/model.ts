// TODO §3.8 — `suspects` : Six suspects (pass · asym).
// Trois questions binaires, une accusation. La génération garantit par recherche exhaustive que trois questions suffisent toujours.
//
// ─────────────────────────────────────────────────────────────────────────────
...
export class SuspectsModel {
  ...
  private cur: 0 | 1;
  private remaining = SUSPECTS_TAPS;
