// TODO §3.4 — `tiles` : Dominos croisés (pass · duel).
// Domineering 6×6 : l'un pose debout, l'autre couché. Toutes les poses légales sont surlignées, et seules elles sont tappables.
//
// ─────────────────────────────────────────────────────────────────────────────
