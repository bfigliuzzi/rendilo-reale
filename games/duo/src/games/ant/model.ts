// TODO §3.6 — `ant` : Le géant et la fourmi (side · asym).
// Le petit court vers la fleur, le grand fait tomber des blocs — jamais sur la fourmi ni à moins de ANT_BLOCK_MIN_DIST d'elle.
//
// ─────────────────────────────────────────────────────────────────────────────
